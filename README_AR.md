...
تقوم الإضافة بالبحث في صفحة فيسبوك عن العناوين التي تحتوي على "أشخاص قد تعرفهم" أو "People You May Know". عند العثور عليها، تقوم بإخفاء البطاقة بالكامل. تستخدم الإضافة تقنية `MutationObserver` لمراقبة الصفحة باستمرار، مما يضمن إخفاء الأقسام الجديدة التي تظهر أثناء التمرير لأسفل.
